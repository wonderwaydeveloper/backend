...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Configure the number of shards for horizontal scaling.
    | Each shard will be a separate database connection.
    |
    */

    'shards_count' => env('DB_SHARDS_COUNT', 4),
    'sharding_enabled' => env('DB_SHARDING_ENABLED', false),
    ...
    */
    ...
    'redis' => [
        ...
        'options' => [
            'cluster' => env('REDIS_CLUSTER_ENABLED', false) ? 'redis' : false,
