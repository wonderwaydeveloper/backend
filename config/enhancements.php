...
return [
    'elasticsearch' => [
        ...
        'index' => env('ELASTICSEARCH_INDEX', 'clevlance'),
    ...
    'cdn' => [
        ...
        'endpoints' => [
            'images' => env('CDN_IMAGES_URL', 'https://cdn-images.clevlance.com'),
            'videos' => env('CDN_VIDEOS_URL', 'https://cdn-videos.clevlance.com'),
            'static' => env('CDN_STATIC_URL', 'https://cdn-static.clevlance.com'),
        ],
        'aws' => [
