...
public function store(Request $request)
{
    ...
    try {
        ...
        // بررسی اینکه کاربر زیر سن است
        if (!$child->is_underage) {
            return GenericResource::error('User is not underage', 400);
        }

        // بررسی authorization - استفاده از Policy
        $this->authorize('manageParentalControls', $child);
        ...
        return GenericResource::error('Unauthorized', 403);
    } catch (\Exception $e) {
    ...
    public function update(Request $request, $childId)
    {
        ...
        try {
            ...
            if (!$child) {
                return GenericResource::error('Child not found', 404);
            }
    ...
    public function index(Request $request)
    {
        try {
            // بررسی authorization
            $this->authorize('viewParentalControls', User::class);
