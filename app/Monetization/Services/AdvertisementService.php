...
class AdvertisementService
{
    public function createAdvertisement(array $data): Advertisement
    {
        return Advertisement::create([
            ...
            'budget' => $data['budget'],
            'cost_per_click' => $data['cost_per_click'] ?? config('monetization.advertisements.default_cost_per_click'),
            'cost_per_impression' => $data['cost_per_impression'] ?? config('monetization.advertisements.default_cost_per_impression'),
