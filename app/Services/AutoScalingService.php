...
class AutoScalingService
{
    ...
    {
        return Cache::remember('cpu_usage', config('performance.cache.cpu_usage'), function () {
    ...
    {
        return Cache::remember('memory_usage', config('performance.cache.memory_usage'), function () {
    ...
    {
        return Cache::remember('active_connections', config('performance.cache.active_connections'), function () {
            try {
    ...
    {
        return Cache::remember('queue_size', config('performance.cache.queue_size'), function () {
            try {
                return Queue::size();
            } catch (\Exception $e) {
                return 0;
